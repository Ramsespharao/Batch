...
:SLoop
    ...
    :: Make the hor line
    set "HL=" & for /l %%i in (1,1,!_Lng[B]!) do (set HL=!HL! /a 0 )
    ...
    :: Make the button
    set Top_Left=/g %XBPB% %YBPB% /a 0
    set Top_Rihgt=/g %XBPE% %YBPB% /a 0
    set Base_Left=/g %XBPB% %YBPE% /a 0
    set Base_Right=/g %XBPE% %YBPE% /a 0
    set Hor_Line=/g %XBPM% %YBPB% !HL! /g %XBPM% %YBPE%  !HL!
    set Ver_Line=/g %XBPB% %YBPM% /a 0 /g %XBPE% %YBPM% /a 0
